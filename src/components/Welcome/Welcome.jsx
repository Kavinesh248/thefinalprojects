...
const Welcome = function () {
  return (
    <div className="flex items-center rounded-lg bg-[linear-gradient(288.17deg,#45108A_2.3%,#3D065F_29.86%,#10054D_101.35%)] px-8 py-6 text-center text-[2rem] font-medium text-white md:px-10 md:py-8 md:text-[2.6rem] xl:px-12 xl:py-10 xl:text-[2.4rem]">
